...
module ApplicationTests
  class UpdateTest < Minitest::Test
    ...
    def rubygems_app_update_available
      proc do |env|
        [200, { 'Content-Type' => 'application/json' }, [ { "name" => "nsrr", "version" => "NEW_VERSION_NUMBER" }.to_json ]]
      end
    end
    ...
    def rubygems_app_version_up_to_date
      proc do |env|
        [200, { 'Content-Type' => 'application/json' }, [ { "name" => "nsrr", "version" => Nsrr::VERSION::STRING }.to_json ]]
      end
    end
